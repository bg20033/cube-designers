...
type ProductionSpeed = "Fast" | "Standard" | "Custom"
...
export default function ShopPage() {
  ...
  const [cart, setCart] = useState<CartItem[]>(() => {
    try {
      const savedCart = window.localStorage.getItem("cube-shop-cart-v1")
  ...
  useEffect(() => {
    window.localStorage.setItem("cube-shop-cart-v1", JSON.stringify(cart))
  }, [cart])
